...
sourceCpp('code/src/train.cpp')
sourceCpp('code/src/count.cpp')
sourceCpp('code/src/read.cpp')
source('code/R/model.R')
source('code/R/utils.R')
source('code/R/posterior.R')
source('code/R/keyATM.R')

WLDA = function(corpus, k, type='infor_bdc', seed=0, iterations=1500, priors=NULL,
